...
public class MainPageGui {
	...
	*/ 
	...
	private void initialize() throws IOException {
		frame.setTitle("BlaBlaSpellChecker MainPage");
		...
		JButton openSCBut = new JButton("Open BlaBlaSpellChecker");
		...
		dummy1.setLayout( new BorderLayout(0,0));
		information.setFont(new Font("Dialog", Font.PLAIN, 20));
		information.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frame,"Hello, Welcome to SpellChecker.\nTo use it:\n1-Go to FreeWriting page\n2-Write whatever you want and click to the 'check' button\n3- Now you can see the wrong words with red or yellow color depending on the theme and you can fix these\n4-After you checked all the words you can add them to MyList, which is your special word book, by double-clicking");  
			}
		});
		dummy1.add(information, BorderLayout.EAST);
